...
namespace DitecLibrarySystem
{
    class DataLink
    {
        public static MySqlConnection libConnection = new MySqlConnection("Server=localhost;userid=root;password=;database=db_library;Convert Zero Datetime=True;charSet=utf8;");
